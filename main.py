...
if __name__ == "__main__":
    ...
    default_modelckpt_cfg = {
        ...
        "params": {
            ...
            # "save_top_k": 20,
            # "mode": "max",
            # "every_n_train_steps": 20*opt.ckpt_n,
        }
    }
    ...
    if opt.save_best:
        ...
        default_modelckpt_cfg["params"]["monitor"] = 'global_step'
        default_modelckpt_cfg["params"]["save_top_k"] = 20
        default_modelckpt_cfg["params"]["mode"] = 'max'
        default_modelckpt_cfg["params"]["every_n_train_steps"] = 2410
    ...
    bs, base_lr = config.data.params.batch_size, opt.learning_rate
